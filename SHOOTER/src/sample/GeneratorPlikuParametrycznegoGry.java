...
public class GeneratorPlikuParametrycznegoGry {
	...
	void zapiszPlikParametryczny(String nazwaPliku) {
		PrintWriter pw = null;
		try {
			pw = new PrintWriter(new BufferedWriter(new PrintWriter(nazwaPliku,"UTF-8")));
		...
		if (losowo(0, 1) == 0) { // tło jednolite
			pw.println("tło=jednolite" + lsep
					+ "kolorTłaR=" + losowo(0, 255) + lsep
					+ "kolorTłaG=" + losowo(0,255)  + lsep
					+ "kolorTłaB=" + losowo(0,255)  + lsep
